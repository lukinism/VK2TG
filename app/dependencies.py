...
from app.services.token_monitor import TokenMonitorService
...
class Container:
    def __init__(self) -> None:
        ...
        self.token_monitor = TokenMonitorService(self.storage, self.logger, self.vk_client, self.telegram_client)
        ...
        self.worker = PollingWorker(self.storage, self.logger, self.transfer_service, self.token_monitor)
